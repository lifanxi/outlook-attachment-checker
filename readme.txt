...
Every time you send a email with the keyword "attach*" (case insensitive) or "附件" (This is Chinese for the word "attachment") in the message body or subject without attaching an attachment, a message box will pop up to warn you about this and let you choose whether you really want to send the mail.
